...
public class Enande {
    ...
    public static void main(String[] args) throws Exception {
        String cryptKey = "@QWE$>@adsf12";
        for(int i=0;i<100;i++){
            long start = System.currentTimeMillis();
//        System.out.println(start);
            String data = "35772"+i;
            try {
                String t1 = Enande.encrypt(data, cryptKey);
                String t2 = Enande.decrypt(t1, cryptKey);
        ...
        String t2 = Enande.decrypt("D479C90CD40E0AA6", cryptKey);
        System.out.println(t2);
